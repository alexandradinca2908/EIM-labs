...
public class GoogleMapsActivity extends AppCompatActivity implements GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener {
    ...
    private class AddPlaceButtonListener implements Button.OnClickListener {
        ...
        public void onClick(View view) {
            ...
            navigateToLocation(Double.parseDouble(latitudeContent), Double.parseDouble(longitudeContent));
            ...
            places.add(new Place(Double.parseDouble(latitudeContent), Double.parseDouble(longitudeContent),
                    nameContent, markerTypeSpinner.getSelectedItemPosition()));
